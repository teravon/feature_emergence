from profiling_and_attack import mlp_eshard, information, pi_mlp_probe, mlp, cnn, cnn_eshard_small
...
for i in range(1, 101, 1):
    ...
    out_layer = model.layers[layer].output
...
np.savez(f"data/pi_eshard_layer_mlp_{layer}_small_probe.npz", pi_hw_s1=np.array(pi_hw_s1), pi_hw_s2=np.array(pi_hw_s2), pi_label=np.array(pi_label), irrelevant_features=irrelevant_features)