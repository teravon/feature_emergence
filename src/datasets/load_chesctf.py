...
class ReadCHESCTF:
    ...
    def load_dataset(self):
        ...
        self.profiling_plaintexts = profiling_plaintext[:self.n_profiling]
        self.profiling_keys = profiling_key[:self.n_profiling]
        ...
        self.labels_key_hypothesis_validation = self.create_labels_key_guess(self.validation_plaintexts)
