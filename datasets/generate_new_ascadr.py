...
def generate_nopoi(window):
    ...
    in_file = h5py.File(f'{ascadr_raw_traces}/atmega8515-raw-traces.h5', "r")
    traces = in_file["traces"][:, 70000:90000]
    ...
    out_file = h5py.File(f'{ascadr_raw_traces}/ascad-variable_70k-90k_{window}.h5', 'w')
